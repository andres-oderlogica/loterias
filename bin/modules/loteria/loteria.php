...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script src='../../../lib/data_table.js?v=<?php echo str_replace('.', '', microtime(true)); ?>'></script>
     ...
     <script src='js/loteria.js?v=<?php echo str_replace('.', '', microtime(true)); ?>'></script>
             ...
             <div class="col-md-4">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form id="form_loterias" action="clases/control_loteria.php">                           
                            <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>">
                            <div class="col-md-12">
                              <label for="descripcion_loteria">Digite Nombre Loteria:</label>
                              <input class="form-control" type="text" id="descripcion_loteria" name="descripcion_loteria" required="true"><br>
                                </div>                                                              
